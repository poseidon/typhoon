...
In this tutorial, we'll network boot and provision a Kubernetes v1.28.2 cluster on bare-metal with Fedora CoreOS.
...
```tf
module "mercury" {
  source = "git::https://github.com/poseidon/typhoon//bare-metal/fedora-coreos/kubernetes?ref=v1.28.2"
