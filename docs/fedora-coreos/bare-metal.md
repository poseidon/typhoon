...
In this tutorial, we'll network boot and provision a Kubernetes v1.33.3 cluster on bare-metal with Fedora CoreOS.
...
```tf
module "mercury" {
  source = "git::https://github.com/poseidon/typhoon//bare-metal/fedora-coreos/kubernetes?ref=v1.33.3"
...
module "mercury-node1" {
  source = "git::https://github.com/poseidon/typhoon//bare-metal/fedora-coreos/kubernetes/worker?ref=v1.33.3"
...
node1.example.com   Ready   <none>  10m  v1.33.3
node2.example.com   Ready   <none>  10m  v1.33.3
node3.example.com   Ready   <none>  10m  v1.33.3
```
