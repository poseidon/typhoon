...
In this tutorial, we'll network boot and provision a Kubernetes v1.20.2 cluster on bare-metal with Fedora CoreOS.
...
```tf
module "mercury" {
  source = "git::https://github.com/poseidon/typhoon//bare-metal/fedora-coreos/kubernetes?ref=v1.20.2"
...
node1.example.com   Ready   <none>  10m  v1.20.2
node2.example.com   Ready   <none>  10m  v1.20.2
node3.example.com   Ready   <none>  10m  v1.20.2
```
