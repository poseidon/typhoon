...
In this tutorial, we'll create a Kubernetes v1.26.3 cluster on Google Compute Engine with Fedora CoreOS.
...
yavin-controller-0.c.example-com.internal  <none>   Ready   6m   v1.26.3
yavin-worker-jrbf.c.example-com.internal   <none>   Ready   5m   v1.26.3
yavin-worker-mzdm.c.example-com.internal   <none>   Ready   5m   v1.26.3
```
