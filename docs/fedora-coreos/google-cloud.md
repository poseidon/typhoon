...
In this tutorial, we'll create a Kubernetes v1.35.4 cluster on Google Compute Engine with Fedora CoreOS.
...
```tf
module "yavin" {
  source = "git::https://github.com/poseidon/typhoon//google-cloud/fedora-coreos/kubernetes?ref=v1.35.4"
