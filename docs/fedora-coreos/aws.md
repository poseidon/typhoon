...
In this tutorial, we'll create a Kubernetes v1.20.3 cluster on AWS with Fedora CoreOS.
...
```tf
module "tempest" {
  source = "git::https://github.com/poseidon/typhoon//aws/fedora-coreos/kubernetes?ref=v1.20.3"
