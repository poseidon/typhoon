...
In this tutorial, we'll create a Kubernetes v1.27.3 cluster on AWS with Fedora CoreOS.
...
ip-10-0-3-155  Ready   <none>   10m  v1.27.3
ip-10-0-26-65  Ready   <none>   10m  v1.27.3
ip-10-0-41-21  Ready   <none>   10m  v1.27.3
```
