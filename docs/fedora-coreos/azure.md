...
In this tutorial, we'll create a Kubernetes v1.30.4 cluster on Azure with Fedora CoreOS.
...
```tf
module "ramius" {
  source = "git::https://github.com/poseidon/typhoon//azure/fedora-coreos/kubernetes?ref=v1.30.4"
...
ramius-controller-0   Ready   <none>  24m  v1.30.4
ramius-worker-000001  Ready   <none>  25m  v1.30.4
ramius-worker-000002  Ready   <none>  24m  v1.30.4
```
