...
In this tutorial, we'll create a Kubernetes v1.28.1 cluster on Azure with Fedora CoreOS.
...
```tf
module "ramius" {
  source = "git::https://github.com/poseidon/typhoon//azure/fedora-coreos/kubernetes?ref=v1.28.1"
