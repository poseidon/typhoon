...
In this tutorial, we'll create a Kubernetes v1.20.0-rc.0 cluster on DigitalOcean with Fedora CoreOS.
...
```tf
module "nemo" {
  source = "git::https://github.com/poseidon/typhoon//digital-ocean/fedora-coreos/kubernetes?ref=v1.20.0-rc.0"
...
10.132.110.130     Ready   <none>  10m  v1.20.0-rc.0
10.132.115.81      Ready   <none>  10m  v1.20.0-rc.0
10.132.124.107     Ready   <none>  10m  v1.20.0-rc.0
```
