...
In this tutorial, we'll create a Kubernetes v1.24.0-rc.1 cluster on DigitalOcean with Fedora CoreOS.
...
```tf
module "nemo" {
  source = "git::https://github.com/poseidon/typhoon//digital-ocean/fedora-coreos/kubernetes?ref=v1.24.0-rc.1"
