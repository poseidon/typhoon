...
In this tutorial, we'll create a Kubernetes v1.16.0-rc.1 cluster on AWS with Container Linux.
...
```tf
module "tempest" {
  source = "git::https://github.com/poseidon/typhoon//aws/container-linux/kubernetes?ref=v1.16.0-rc.1"
...
ip-10-0-3-155  Ready   controller,master  10m  v1.16.0-rc.1
ip-10-0-26-65  Ready   node               10m  v1.16.0-rc.1
ip-10-0-41-21  Ready   node               10m  v1.16.0-rc.1
```
