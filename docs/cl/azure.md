...
In this tutorial, we'll create a Kubernetes v1.16.0-rc.1 cluster on Azure with Container Linux.
...
```tf
module "ramius" {
  source = "git::https://github.com/poseidon/typhoon//azure/container-linux/kubernetes?ref=v1.16.0-rc.1"
...
ramius-controller-0   Ready   controller,master  24m  v1.16.0-rc.1
ramius-worker-000001  Ready   node               25m  v1.16.0-rc.1
ramius-worker-000002  Ready   node               24m  v1.16.0-rc.1
```
