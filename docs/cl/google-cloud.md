...
In this tutorial, we'll create a Kubernetes v1.16.0-rc.1 cluster on Google Compute Engine with Container Linux.
...
module "google-cloud-yavin" {
  source = "git::https://github.com/poseidon/typhoon//google-cloud/container-linux/kubernetes?ref=v1.16.0-rc.1"
...
yavin-controller-0.c.example-com.internal  controller,master  Ready   6m   v1.16.0-rc.1
yavin-worker-jrbf.c.example-com.internal   node               Ready   5m   v1.16.0-rc.1
yavin-worker-mzdm.c.example-com.internal   node               Ready   5m   v1.16.0-rc.1
```
