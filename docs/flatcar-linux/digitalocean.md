...
In this tutorial, we'll create a Kubernetes v1.22.4 cluster on DigitalOcean with Flatcar Linux.
...
```tf
module "nemo" {
  source = "git::https://github.com/poseidon/typhoon//digital-ocean/flatcar-linux/kubernetes?ref=v1.22.4"
