...
In this tutorial, we'll create a Kubernetes v1.35.4 cluster on DigitalOcean with Flatcar Linux.
...
```tf
module "nemo" {
  source = "git::https://github.com/poseidon/typhoon//digital-ocean/flatcar-linux/kubernetes?ref=v1.35.4"
...
10.132.110.130     Ready   <none>  10m  v1.35.4
10.132.115.81      Ready   <none>  10m  v1.35.4
10.132.124.107     Ready   <none>  10m  v1.35.4
```
