...
In this tutorial, we'll create a Kubernetes v1.24.1 cluster on Azure with Flatcar Linux.
...
```tf
module "ramius" {
  source = "git::https://github.com/poseidon/typhoon//azure/flatcar-linux/kubernetes?ref=v1.24.1"
