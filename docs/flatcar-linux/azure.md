...
In this tutorial, we'll create a Kubernetes v1.33.3 cluster on Azure with Flatcar Linux.
...
ramius-controller-0   Ready   <none>  24m  v1.33.3
ramius-worker-000001  Ready   <none>  25m  v1.33.3
ramius-worker-000002  Ready   <none>  24m  v1.33.3
```
