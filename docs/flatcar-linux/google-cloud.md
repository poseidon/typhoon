...
In this tutorial, we'll create a Kubernetes v1.26.0-rc.0 cluster on Google Compute Engine with Flatcar Linux.
...
```tf
module "yavin" {
  source = "git::https://github.com/poseidon/typhoon//google-cloud/flatcar-linux/kubernetes?ref=v1.26.0-rc.0"
...
yavin-controller-0.c.example-com.internal  <none>   Ready   6m   v1.26.0-rc.0
yavin-worker-jrbf.c.example-com.internal   <none>   Ready   5m   v1.26.0-rc.0
yavin-worker-mzdm.c.example-com.internal   <none>   Ready   5m   v1.26.0-rc.0
```
