...
In this tutorial, we'll create a Kubernetes v1.20.2 cluster on Google Compute Engine with Flatcar Linux.
...
```tf
module "yavin" {
  source = "git::https://github.com/poseidon/typhoon//google-cloud/flatcar-linux/kubernetes?ref=v1.20.2"
