...
In this tutorial, we'll create a Kubernetes v1.22.3 cluster on AWS with Flatcar Linux.
...
```tf
module "tempest" {
  source = "git::https://github.com/poseidon/typhoon//aws/flatcar-linux/kubernetes?ref=v1.22.3"
