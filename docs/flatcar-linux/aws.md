...
In this tutorial, we'll create a Kubernetes v1.26.0-rc.0 cluster on AWS with Flatcar Linux.
...
ip-10-0-3-155  Ready   <none>  10m  v1.26.0-rc.0
ip-10-0-26-65  Ready   <none>  10m  v1.26.0-rc.0
ip-10-0-41-21  Ready   <none>  10m  v1.26.0-rc.0
```
