...
In this tutorial, we'll create a Kubernetes v1.20.3 cluster on AWS with Flatcar Linux.
...
```tf
module "tempest" {
  source = "git::https://github.com/poseidon/typhoon//aws/flatcar-linux/kubernetes?ref=v1.20.3"
...
ip-10-0-3-155  Ready   <none>  10m  v1.20.3
ip-10-0-26-65  Ready   <none>  10m  v1.20.3
ip-10-0-41-21  Ready   <none>  10m  v1.20.3
```
