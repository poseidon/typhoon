...
In this tutorial, we'll network boot and provision a Kubernetes v1.25.4 cluster on bare-metal with Flatcar Linux.
...
node1.example.com   Ready   <none>  10m  v1.25.4
node2.example.com   Ready   <none>  10m  v1.25.4
node3.example.com   Ready   <none>  10m  v1.25.4
```
